...
if (strcmp(User_Choice,'1')==1)
    ...
    for sacle_idx=2:6
        ...
        GT_ComputeGaborIR_Frontal(sacle_idx); %gabor features computed for a particular scale
        GT_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx); %append gabor features calculated from each facial half
    ...
    [final_accuracy_MN] = run_Gabor_libsvm_Full(GT_Gabor_HM_M_Frontal,GT_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    %======================================================%
    ...
    [final_accuracy_PN] = run_Gabor_libsvm_Full(GT_Gabor_HM_P_Frontal,GT_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)%%%%%%%%%%upto this
...
elseif (strcmp(User_Choice,'2')==1)
    ...
    [final_accuracy_MN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_M_F,AgeAdjust_GT_Gabor_HM_N_F,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    ...
    [final_accuracy_PN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_P_F,AgeAdjust_GT_Gabor_HM_N_F,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
...
elseif (strcmp(User_Choice,'3')==1)
    ...
    [final_accuracy_MN] = run_Gabor_libsvm_Full(GT_Gabor_HM_M_Profile,GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    ...
    [final_accuracy_PN] = run_Gabor_libsvm_Full(GT_Gabor_HM_P_Profile,GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
...
elseif (strcmp(User_Choice,'4')==1)
    ...
    [final_accuracy_MN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_M_Profile,AgeAdjust_GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    ...
    [final_accuracy_PN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_P_Profile,AgeAdjust_GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
...
elseif (strcmp(User_Choice,'5')==1)
    ...
    [final_accuracy_MN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Frontal,AROI_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    ...
    [final_accuracy_PN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_P_Frontal,AROI_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
...
elseif (strcmp(User_Choice,'6')==1)
    ...
    for sacle_idx=2:6
     %     GT_ComputeGaborIR_Profile(sacle_idx);
      %7    GT_Gabor_HMFeatures_between_lt_and_rt_haralic_Profile(sacle_idx);
        cd('..\Classification\libsvm-3.20\matlab')
        load(['..\..\..\GaborFeatures_HM_allScale\GT_Gabor_HM_Malignant_Profile_face_scale_',num2str(sacle_idx),'.mat']);
        load(['..\..\..\GaborFeatures_HM_allScale\GT_Gabor_HM_Normal_Profile_face_scale_',num2str(sacle_idx),'.mat']);
        load(['..\..\..\GaborFeatures_HM_allScale\GT_Gabor_HM_Precancer_Profile_face_scale_',num2str(sacle_idx),'.mat']);
    ...
    Setting='PROFILE_GT_MN_FULL';
     ...
     [final_accuracy_MN] = run_Gabor_libsvm_Full(GT_Gabor_HM_M_Profile,GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
%       [final_accuracy_MN,sensivity_MN,specificity_MN]=run_Gabor_libsvm_Full(GT_Gabor_HM_M_Profile,GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting);
    cd('../../../');
