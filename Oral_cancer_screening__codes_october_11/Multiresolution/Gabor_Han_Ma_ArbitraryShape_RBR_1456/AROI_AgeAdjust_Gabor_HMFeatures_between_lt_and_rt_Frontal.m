...
% =========================== AROI_AgeAdjust_Gabor_HMFeatures_between_lt_and_rt_Frontal.m ====================================== %
% Description  : 
% 
%
%
...
function AROI_AgeAdjust_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx)
...
cd([rel_path 'AROI_AgeAdjust_Gabor_Han&Ma_Normal_Front_' nameFolds{folder_idx}]);
load('AROI_AgeAdjust_Gabor_H&M_Normal_Front.mat')
...
save(['..\GaborFeatures_HM_allScale\AROI_AgeAdjust_Gabor_HM_Normal_Frontal_face_scale_',num2str(sacle_idx),'.mat'],'AROI_Normal_Gabor_HM_Diff_LT_RT_Frontface','AROI_Normal_Gabor_HM_mean_LT_RT_Frontface','AROI_Normal_Gabor_HM_append_LT_RT_Frontface');
%%
 %Malignant
...
cd([rel_path '\AROI_AgeAdjust_Gabor_Han&Ma_Malignant_Front_' nameFolds{folder_idx}]);
load('AROI_AgeAdjust_Gabor_H&M_Malignant_Front.mat')
...
save(['..\GaborFeatures_HM_allScale\AROI_AgeAdjust_Gabor_HM_Malignant_Frontal_face_scale_',num2str(sacle_idx),'.mat'],'AROI_Malignant_Gabor_HM_Diff_LT_RT_Frontface','AROI_Malignant_Gabor_HM_mean_LT_RT_Frontface' ,'AROI_Malignant_Gabor_HM_append_LT_RT_Frontface');
...
cd([rel_path '\AROI_AgeAdjust_Gabor_Han&Ma_precancer_Front_' nameFolds{folder_idx}]);
load('AROI_AgeAdjust_Gabor_H&M_precancer_Front.mat')
...
save(['..\GaborFeatures_HM_allScale\AROI_AgeAdjust_Gabor_HM_Precancer_Frontal_face_scale_',num2str(sacle_idx),'.mat'],'AROI_Precancer_Gabor_HM_Diff_LT_RT_Frontface','AROI_Precancer_Gabor_HM_mean_LT_RT_Frontface' ,'AROI_Precancer_Gabor_HM_append_LT_RT_Frontface');
end