...
%------------------------------------------------------------------------------------%  
% Output parameter: 
%                 Full_AROI_MR8_Normal_Front 
%                   AROI_MR8_F_normal_lt
%                   AROI_MR8_F_normal_rt 
%                 Full_AROI_MR8_Precancer_Front 
%                   AROI_MR8_F_precancer_lt 
%                   AROI_MR8_F_precancer_rt 
%                 Full_AROI_MR8_Malignant_Front
%                  AROI_MR8_F_malignant_lt
%                   AROI_MR8_F_malignant_rt
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
...
for folder_idx=1:no_dir
            ...
            %-------------------------------------------------loading Automated facial mask-------------------------------------------------------------------------------------------%
                ...
                folder_name=['..\..\..\ThermalDatabase\Normal\', nameFolds{folder_idx}, '\A_ROI_Front_' nameFolds{folder_idx}];
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              ...
              cd(rel_path);
              folder_name=['AROI_MR8_Normal_Front_' nameFolds{folder_idx}];
                ...
                save('Full_AROI_MR8_Normal_Front','AROI_MR8_F_normal_lt','AROI_MR8_F_normal_rt');
...
for folder_idx=1:no_dir
            ...
            cd(rel_path);
            folder_name=['AROI_MR8_Malignant_Front_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('Full_AROI_MR8_Malignant_Front','AROI_MR8_F_malignant_lt','AROI_MR8_F_malignant_rt');
...
% 
            ...
            cd(rel_path);
            folder_name=['AROI_MR8_precancer_Front_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('Full_AROI_MR8_Precancer_Front','AROI_MR8_F_precancer_lt','AROI_MR8_F_precancer_rt');
