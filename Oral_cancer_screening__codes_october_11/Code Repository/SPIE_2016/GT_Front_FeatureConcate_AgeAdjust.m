% =========================== GT_Front_FeatureConcate_AgeAdjust.m ====================================== %
% Description  : 
% 
%
%
...
% ===================================================================== %
function GT_Front_FeatureConcate_AgeAdjust
%%
clear;
clc;
close all;
...
cd([rel_path '\GT_Histogram_Error_' nameFolds{folder_idx}]);
load('GT_Histogram_Error_FrontFace.mat')
MAE128_Front_Normal(error_idx)=MAE128;
error_idx=error_idx+1;
cd('..\..\..\..\code repository\SPIE_2016');
end
save('ErrorHistogram\AgeAdjust_GT_ErrorHistogram_Normal_Frontal_face.mat','MAE128_Front_Normal');
...
cd([rel_path '\GT_Histogram_Error_' nameFolds{folder_idx}]);
load('GT_Histogram_Error_FrontFace.mat')
MAE128_Front_Malignant(error_idx)=MAE128;
error_idx=error_idx+1;
cd('..\..\..\..\code repository\SPIE_2016');
end
save('ErrorHistogram\AgeAdjust_GT_ErrorHistogram_Malignant_Frontal_face.mat','MAE128_Front_Malignant');
...
cd([rel_path '\GT_Histogram_Error_' nameFolds{folder_idx}]);
load('GT_Histogram_Error_FrontFace.mat')
MAE128_Front_NonMalignant(error_idx)=MAE128;
error_idx=error_idx+1;
cd('..\..\..\..\code repository\SPIE_2016');
end
save('ErrorHistogram\AgeAdjust_GT_ErrorHistogram_NonMalignant_Frontal_face.mat','MAE128_Front_NonMalignant');
end