% =========================== AgeAdjusted_GT_Gabor_HMFeatures_between_lt_and_rt_Profile.m ====================================== %
% Description  : 
% 
%
%
...
%------------------------------------------------------------------------------------%  
% Output parameter: 
%                   AgeAdjust_GT_Precancer_Gabor_HM_Diff_LT_RT_Profileface   
%                   AgeAdjust_GT_Precancer_Gabor_HM_mean_LT_RT_Profileface 
%                   AgeAdjust_GT_Precancer_Gabor_HM_append_LT_RT_Profileface
%                   AgeAdjust_GT_Malignant_Gabor_HM_Diff_LT_RT_Profileface   
%                   AgeAdjust_GT_Malignant_Gabor_HM_mean_LT_RT_Profileface 
%                   AgeAdjust_GT_Malignant_Gabor_HM_append_LT_RT_Profileface
%                   AgeAdjust_GT_Normal_Gabor_HM_Diff_LT_RT_Profileface   
%                   AgeAdjust_GT_Normal_Gabor_HM_mean_LT_RT_Profileface 
%                   AgeAdjust_GT_Normal_Gabor_HM_append_LT_RT_Profileface
%                    
%                  
%                    
%------------------------------------------------------------------------------------%
...
function AgeAdjust_GT_Gabor_HMFeatures_between_lt_and_rt_Profile(sacle_idx)
close all;
%%
 %Normal
...
cd([rel_path 'AgeAdjust_GT_Gabor_Han&Ma_Normal_Profile_' nameFolds{folder_idx}]);
load('AgeAdjust_GT_Gabor_H&M_Normal_Profile.mat')
...
save(['..\GaborFeatures_HM_allScale\AgeAdjust_GT_Gabor_HM_Normal_Profile_face_scale_',num2str(sacle_idx),'.mat'],'GT_Normal_Gabor_HM_Diff_LT_RT_Profileface','GT_Normal_Gabor_HM_mean_LT_RT_Profileface','GT_Normal_Gabor_HM_append_LT_RT_Profileface');
%%
 %Malignant
...
cd([rel_path 'AgeAdjust_GT_Gabor_Han&Ma_Malignant_Profile_' nameFolds{folder_idx}]);
load('AgeAdjust_GT_Gabor_H&M_Malignant_Profile.mat')
...
save(['..\GaborFeatures_HM_allScale\AgeAdjust_GT_Gabor_HM_Malignant_Profile_face_scale_',num2str(sacle_idx),'.mat'],'GT_Malignant_Gabor_HM_Diff_LT_RT_Profileface','GT_Malignant_Gabor_HM_mean_LT_RT_Profileface' ,'GT_Malignant_Gabor_HM_append_LT_RT_Profileface');
...
cd([rel_path 'AgeAdjust_GT_Gabor_Han&Ma_precancer_Profile_' nameFolds{folder_idx}]);
load('AgeAdjust_GT_Gabor_H&M_precancer_Profile.mat')
...
save(['..\GaborFeatures_HM_allScale\AgeAdjust_GT_Gabor_HM_Precancer_Profile_face_scale_',num2str(sacle_idx),'.mat'],'GT_Precancer_Gabor_HM_Diff_LT_RT_Profileface','GT_Precancer_Gabor_HM_mean_LT_RT_Profileface' ,'GT_Precancer_Gabor_HM_append_LT_RT_Profileface');
end