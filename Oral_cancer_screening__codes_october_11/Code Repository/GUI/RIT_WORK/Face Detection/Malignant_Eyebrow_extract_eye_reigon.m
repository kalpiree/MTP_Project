...
%%   Determining the modified r_min 
    ...
    % For Left Face
     ...
     r_eye_lt_region_max=ceil((rmax-find_r_min_lt_index)*(1/2))+find_r_min_lt_index;
      
     r_eye_rt_region_max=ceil((rmax-find_r_min_rt_index)*(1/2))+find_r_min_rt_index;
