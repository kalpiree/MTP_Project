% =========================== AgeAdjust_GT_ComputeGaborIR_Profile.m ====================================== %
% Description  : 
% 
%
%
...
%                    
%------------------------------------------------------------------------------------%  
% Output parameter:  AgeAdjust_GT_Gabor_H&M_Precancer_Profile 
...
function AgeAdjust_GT_ComputeGaborIR_Profile(sacle_idx)
%%
...
%             I1_rt=mat2gray(I1_rt);
       ...
       %-------------------------------------------------loading Ground Truth facial mask-------------------------------------------------------------------------------------------%
            ...
            cd(rel_path);
            folder_name=['AgeAdjust_GT_Gabor_Han&Ma_Normal_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                ...
                save('AgeAdjust_GT_Gabor_H&M_Normal_Profile','GT_gabor_P_normal_lt','GT_gabor_P_normal_rt');
...
%             I1_rt=mat2gray(I1_rt,[0 255]);
           ...
           %-------------------------------------------------loading Manual facial mask-------------------------------------------------------------------------------------------%
            ...
            cd(rel_path);
            folder_name=['AgeAdjust_GT_Gabor_Han&Ma_Malignant_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('AgeAdjust_GT_Gabor_H&M_Malignant_Profile','GT_gabor_P_malignant_lt','GT_gabor_P_malignant_rt');
...
% 
            ...
            cd(rel_path);
            folder_name=['AgeAdjust_GT_Gabor_Han&Ma_precancer_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('AgeAdjust_GT_Gabor_H&M_Precancer_Profile','GT_gabor_P_precancer_lt','GT_gabor_P_precancer_rt');
