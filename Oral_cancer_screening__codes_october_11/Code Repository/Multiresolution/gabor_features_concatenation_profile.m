...
error_idx=1;
n= n+2;
AROI_Malignant_Gabor_HM_ProfileLTface=zeros(29,n);
AROI_Malignant_Gabor_HM_ProfileRTface=zeros(29,n);
AROI_Malignant_Gabor_HM_Diff_LT_RT_Profileface=zeros(29,n);
AROI_Malignant_Gabor_HM_mean_LT_RT_Profileface=zeros(29,n);
...
%"C:\Users\ntnbs\Downloads\common_database\malignant\P0216\AROI_Gabor_Han&Ma_Malignant_Front_P0216"
...
save(['C:\Users\ntnbs\Downloads\common_database\malignant',num2str(sacle_idx),'.mat'],'AROI_Malignant_Gabor_HM_Diff_LT_RT_Profileface','AROI_Malignant_Gabor_HM_mean_LT_RT_Profileface' ,'AROI_Malignant_Gabor_HM_append_LT_RT_Profileface');
%n=n+2;
end
...
error_idx=1;
n= n+2;
AROI_Normal_Gabor_HM_ProfileLTface=zeros(152,n);
AROI_Normal_Gabor_HM_ProfileRTface=zeros(152,n);
AROI_Normal_Gabor_HM_Diff_LT_RT_Profileface=zeros(152,n);
AROI_Normal_Gabor_HM_mean_LT_RT_Profileface=zeros(152,n);
for folder_idx=1:no_dir
disp(nameFolds(folder_idx)); 
...
save(['C:\Users\ntnbs\Downloads\common_database\normal',num2str(sacle_idx),'.mat'],'AROI_Normal_Gabor_HM_Diff_LT_RT_Profileface','AROI_Normal_Gabor_HM_mean_LT_RT_Profileface' ,'AROI_Normal_Gabor_HM_append_LT_RT_Profileface');
end
%%
n=2;
for sacle_idx=2:6
...
error_idx=1;
n= n+2;
AROI_Precancer_Gabor_HM_ProfileLTface=zeros(34,n);
AROI_Precancer_Gabor_HM_ProfileRTface=zeros(34,n);
AROI_Precancer_Gabor_HM_Diff_LT_RT_Profileface=zeros(34,n);
AROI_Precancer_Gabor_HM_mean_LT_RT_Profileface=zeros(34,n);
for folder_idx=1:no_dir
disp(nameFolds(folder_idx)); 
...
save(['C:\Users\ntnbs\Downloads\common_database\non_malignant',num2str(sacle_idx),'.mat'],'AROI_Precancer_Gabor_HM_Diff_LT_RT_Profileface','AROI_Precancer_Gabor_HM_mean_LT_RT_Profileface' ,'AROI_Precancer_Gabor_HM_append_LT_RT_Profileface');
