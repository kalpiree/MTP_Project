...
for folder_idx=62:no_dir
   ...
   check=[9,6,28,31,36,41,43,44,45,57,58,59,67,79,82,86,88,97,98,102];
...
fullFileName = fullfile('C:\Users\chaithan\Desktop\Malignant1', op_img1);
...
[level,criterion]=graythresh(Left_Img_rmv_cloth(Left_Img_rmv_cloth>0));
sum_level_LtImg_rmvcloth=sum(Left_Img_rmv_cloth(:) <= level)

%[level1,criterion]=graythresh(Left_Img);
if (sum_level_LtImg_rmvcloth<sum_avg_LtImg_rmvcloth)
BW_Left_Img_rmv_cloth = im2bw(Left_Img_rmv_cloth/255,level/255);
...
[level,criterion]=graythresh(Right_Img_rmv_cloth(Right_Img_rmv_cloth>0));
if (level>avg_RtImg)
BW_Right_Img_rmv_cloth = im2bw(Right_Img_rmv_cloth/255,level/255);
...
rel_path=['..\..\Malignant\',nameFolds{folder_idx}];
            cd(rel_path);
...
fullFileName = fullfile('C:\Users\chaithan\Desktop\Malignant1', A_ROI_R_save);
fullFileName=cell2mat(fullFileName);
saveas(gcf,fullFileName,'png')
figure, imshow(logical(A_ROI_R)); title('Logical Right ROI');
A_ROI_R_save_1=strcat(op_img1,'_A_R_ROI_logical');
fullFileName = fullfile('C:\Users\chaithan\Desktop\Malignant1', A_ROI_R_save_1);
fullFileName=cell2mat(fullFileName);
saveas(gcf,fullFileName,'png')
...
fullFileName = fullfile('C:\Users\chaithan\Desktop\Malignant1', A_L_ROI_save);
fullFileName=cell2mat(fullFileName);
saveas(gcf,fullFileName,'png')
  
figure, imshow(logical(A_ROI_L)); title('Logical Left ROI');
A_L_ROI_save_1=strcat(op_img1,'_A_ROI_L_logical');
fullFileName = fullfile('C:\Users\chaithan\Desktop\Malignant1', A_L_ROI_save_1);
fullFileName=cell2mat(fullFileName);
saveas(gcf,fullFileName,'png')
end  