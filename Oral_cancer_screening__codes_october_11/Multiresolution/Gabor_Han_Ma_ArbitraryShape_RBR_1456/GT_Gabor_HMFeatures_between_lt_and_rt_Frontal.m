...
% their difference and mean is calculated , their lt and rt features are appended and stored 
%
%
% ================================================================================== %
...
function GT_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx)
close all;
%%
 %Normal
