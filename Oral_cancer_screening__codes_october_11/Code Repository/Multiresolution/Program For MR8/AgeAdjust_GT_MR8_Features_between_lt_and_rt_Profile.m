...
% =========================== AgeAdjust_GT_MR8_Features_between_lt_and_rt_Profile.m ====================================== %
% Description  : 
% 
% ================================================================================== %
% Input Parameters :
...
function AgeAdjust_GT_MR8_Features_between_lt_and_rt_Profile(ROS_idx)
%%
 %Normal
...
cd([rel_path 'AgeAdjust_GT_MR8_Normal_Profile_' nameFolds{folder_idx} ]);
load('AgeAdjust_GT_MR8_Normal_Profile.mat')
...
save(['..\MR8Features\AgeAdjust_GT_MR8_Normal_Profile_face_ROS_',num2str(ROS_idx),'.mat'],'GT_Normal_MR8_Diff_LT_RT_Profileface','GT_Normal_MR8_mean_LT_RT_Profileface','GT_Normal_MR8_append_LT_RT_Profileface');
%%
 %Malignant
...
cd([rel_path 'AgeAdjust_GT_MR8_Malignant_Profile_' nameFolds{folder_idx}]);
load('AgeAdjust_GT_MR8_Malignant_Profile.mat')
...
save(['..\MR8Features\AgeAdjust_GT_MR8_Malignant_Profile_face_ROS_',num2str(ROS_idx),'.mat'],'GT_Malignant_MR8_Diff_LT_RT_Profileface','GT_Malignant_MR8_mean_LT_RT_Profileface' ,'GT_Malignant_MR8_append_LT_RT_Profileface');
...
cd([rel_path 'AgeAdjust_GT_MR8_precancer_Profile_' nameFolds{folder_idx}]);
load('AgeAdjust_GT_MR8_Precancer_Profile.mat')
...
save(['..\MR8Features\AgeAdjust_GT_MR8_NonMalignant_Profile_face_ROS_',num2str(ROS_idx),'.mat'],'GT_NMalignant_MR8_Diff_LT_RT_Profileface','GT_NMalignant_MR8_mean_LT_RT_Profileface' ,'GT_NMalignant_MR8_append_LT_RT_Profileface');
