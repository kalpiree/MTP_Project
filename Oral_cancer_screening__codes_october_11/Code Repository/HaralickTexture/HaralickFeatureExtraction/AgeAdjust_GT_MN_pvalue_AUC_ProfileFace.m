...
% ===========================AgeAdjusted_GT_MN_pvalue_AUC_FrontalFace.m ====================================== %
...
%   #1:AUC_Features.m
%
% Called by :  AgeAdjusted_GT_MN_pvalue_AUC_FrontalFace.m
%------------------------------------------------------------------------------------%
% Reference:    
%
%
...
% ===================================================================== %
function AgeAdjust_GT_MN_pvalue_AUC_ProfileFace
clear;


enter_pvalue=0.05;

load('..\HaralickFeatures\AgeAdjust_GT_Haralick_Malignant_Profile_face.mat');
...
%%
save('..\HaralickFeatures\SignifantFeatures\AgeAdjust_GT_Significant_Haralick_MalignantNormal_Profile','GT_SignificantMalignant_Profile_LTandRT_append','GT_SignificantNormal_Profile_LTandRT_append');
