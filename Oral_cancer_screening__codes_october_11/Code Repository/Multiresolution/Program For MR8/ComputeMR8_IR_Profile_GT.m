...
%------------------------------------------------------------------------------------%  
% Output parameter: 
%                  GT_MR8_Normal_Profile 
%                   GT_MR8_F_normal_lt
%                   GT_MR8_F_normal_rt 
%                  GT_MR8_Precancer_Profile 
...
% ===================================================================== %
%%
function ComputeMR8_IR_Profile_GT(ROS_idx,N_Scale,N_Orientation)
...
for folder_idx=1:no_dir
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              ...
              cd(rel_path);
              folder_name=['GT_MR8_Normal_Profile_' nameFolds{folder_idx}];
                ...
                save('GT_MR8_Normal_Profile','GT_MR8_F_normal_lt','GT_MR8_F_normal_rt');
...
for folder_idx=1:no_dir
            ...
            cd(rel_path);
            folder_name=['GT_MR8_Malignant_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('GT_MR8_Malignant_Profile','GT_MR8_F_malignant_lt','GT_MR8_F_malignant_rt');
...
% 
            ...
            cd(rel_path);
            folder_name=['GT_MR8_precancer_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('GT_MR8_Precancer_Profile','GT_MR8_F_precancer_lt','GT_MR8_F_precancer_rt');
