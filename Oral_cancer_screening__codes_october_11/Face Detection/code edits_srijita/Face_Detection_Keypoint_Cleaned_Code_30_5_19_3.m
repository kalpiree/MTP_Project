...
disp(filename);
dir=pathname;
%nameFolds=regexp(dir,'\','split'); (this works too)
...
%for folder_idx=no_dir
    ...
    fprintf('Processing Patient ID '); disp(nameFolds); % Display Current Patient ID
    ...
    [BW_mask_F,mask_F,rt_boundary_col,lt_boundary_col,~,lower_boundary_row]=face_detect_new( I_F,nameFolds,folder_idx,op_img1 ); % Perform Face-Detection
