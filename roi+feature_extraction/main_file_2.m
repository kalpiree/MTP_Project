d= dir('C:\Users\ntnbs\Downloads\ThermalDatabase\ThermalDatabase\Normal');
isub = [d(:).isdir];
...
for folder_idx= 1:no_dir
    ...
    rel_path=['C:\Users\ntnbs\Downloads\Database\Normal\',nameFolds{folder_idx}];
    ...
    I_F_1=xlsread(['C:\Users\ntnbs\Downloads\ThermalDatabase\ThermalDatabase\Normal\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'_lt.csv']);
    I_F_2=xlsread(['C:\Users\ntnbs\Downloads\ThermalDatabase\ThermalDatabase\Normal\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'_rt.csv']);
