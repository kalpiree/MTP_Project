function F=makeRFSfilters(ROS_idx,N_Scale,N_Orientation)
...
% Fourier transform.
  ...
  SUP=ROS_idx; %11 %49    
  % Support of the largest filter (must be odd)
  SCALEX=1:N_Scale;         % Sigma_{x} for the oriented filters

  
  NORIENT=N_Orientation;              % Number of orientations
