% ===========================GT_Precancer_Texture_Frontal_Face_thermal.m ====================================== %
...
%------------------------------------------------------------------------------------%  
% Output parameter:  
%  GT_NonMalignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt (13x1 double)
%                  
%  GT_NonMalignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt (13x1 double)
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
%   #1: GLCM_D_THETA.m
%   #2: haralick_ours.m
% Called by :  GT_Precancer_Texture_Frontal_Face_thermal.m
%------------------------------------------------------------------------------------%
% Reference:    
%
...
% ===================================================================== %
function GT_Precancer_Texture_Frontal_Face_thermal 
%%
clear;
clc;
close all;
...
[GT_NonMalignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt]=haralick_ours(GT_ROI_R,sum_GC_d1_theta0_45_90_135_ROI_img_face_rt); % calculating haralik features on rotation invariant GLCM
...
[GT_NonMalignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt]=haralick_ours(GT_ROI_L,sum_GC_d1_theta0_45_90_135_ROI_img_face_lt);
...
save('GT_NonMalignant_Haralick_Frontal_Face_d1_theta0_45_90_135','GT_NonMalignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt','GT_NonMalignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt');
%-------------Saving the Feature------------------------%
