...
load(['..\ThermalDatabase\Malignant\',nameFolds{folder_idx},'\GT_FacialMask\',nameFolds{folder_idx},'_FTmask.mat']); %load the mask created from interactive segmentation tool
...
Frontface_keypts = xlsread('Thermal_Malignant_keypts_FRONTface.xlsx');
