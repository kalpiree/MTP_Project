...
load(['..\ThermalDatabase\Normal\',nameFolds{folder_idx},'\GT_FacialMask\',nameFolds{folder_idx},'_FTmask.mat']); %load the mask created from interactive segmentation tool
...
Frontface_keypts = xlsread('Thermal_Normal_keypts_FRONTface.xlsx');
