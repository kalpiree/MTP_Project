% ===========================GT_Malignant_Texture_Frontal_Profile_thermal.m ====================================== %
% Description  : This function Computes the Haralick features
% from rotational invariant Gray level coccurence matrix of the Profile
% image 
% ================================================================================== %
% Input Parameters :
%                   
...
function GT_Malignant_Texture_Profile_Face_thermal 
%%
clear;
clc;
close all;
...
cd(rel_path);
folder_name=['GT_Thermal_Texture_Profile_Results_' nameFolds{folder_idx}];
...
save('GT_Malignant_Haralick_Profile_Face_d1_theta0_45_90_135','GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt','GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt');
%-------------Saving the Feature------------------------%
