...
%------------------------------------------------------------------------------------%  
% Output parameter:  
%  GT_Significant_Haralick_MalignantNormal_Profile

%  GT_SignificantMalignant_Profile_LTandRT_append 
%  GT_SignificantNormal_Profile_LTandRT_append  
...
function GT_MN_pvalue_AUC_ProfileFace
clear;


enter_pvalue=0.05;

load('..\HaralickFeatures\GT_Haralick_Malignant_Profile_face.mat');
...
% Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface=Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface(1:81,:);
GT_Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface=GT_Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface;
GT_Normal_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface=GT_Normal_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface;
Trainingset_concatinate=[GT_Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface;GT_Normal_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface];

dataTrainMalignant_concatinate =Trainingset_concatinate(1:size(GT_Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface,1),:);
dataTrainNormal_concatinate =Trainingset_concatinate((size(GT_Malignant_haralick_d1_theta_0_45_90_135_append_LT_RT_Pface,1)+1):end,:);
[h_concatinate,p_concatinate,ci_concatinate,stat_concatinate] = ttest2(dataTrainMalignant_concatinate,dataTrainNormal_concatinate,'Vartype','unequal');
...
% idx_significantfeatures_concatinate=[8,21];

GT_SignificantMalignant_Profile_LTandRT_append=dataTrainMalignant_concatinate(1:end,idx_significantfeatures_concatinate);
GT_SignificantNormal_Profile_LTandRT_append=dataTrainNormal_concatinate(1:end,idx_significantfeatures_concatinate);
%%
%%
save('..\HaralickFeatures\SignifantFeatures\GT_Significant_Haralick_MalignantNormal_Profile','GT_SignificantMalignant_Profile_LTandRT_append','GT_SignificantNormal_Profile_LTandRT_append');
