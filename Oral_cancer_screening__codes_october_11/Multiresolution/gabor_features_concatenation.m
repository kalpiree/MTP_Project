...
error_idx=1;
n= n+2;
AROI_Malignant_Gabor_HM_FrontalLTface=zeros(71,n);
AROI_Malignant_Gabor_HM_FrontalRTface=zeros(71,n);
AROI_Malignant_Gabor_HM_Diff_LT_RT_Frontface=zeros(71,n);
AROI_Malignant_Gabor_HM_mean_LT_RT_Frontface=zeros(71,n);
...
error_idx=1;
n= n+2;
AROI_Normal_Gabor_HM_FrontalLTface=zeros(258,n);
AROI_Normal_Gabor_HM_FrontalRTface=zeros(258,n);
AROI_Normal_Gabor_HM_Diff_LT_RT_Frontface=zeros(258,n);
AROI_Normal_Gabor_HM_mean_LT_RT_Frontface=zeros(258,n);
for folder_idx=1:no_dir
disp(nameFolds(folder_idx)); 
...
error_idx=1;
n= n+2;
AROI_Precancer_Gabor_HM_FrontalLTface=zeros(71,n);
AROI_Precancer_Gabor_HM_FrontalRTface=zeros(71,n);
AROI_Precancer_Gabor_HM_Diff_LT_RT_Frontface=zeros(71,n);
AROI_Precancer_Gabor_HM_mean_LT_RT_Frontface=zeros(71,n);
for folder_idx=1:no_dir
disp(nameFolds(folder_idx)); 
