function [A_ROI_R_img, A_ROI_L_img] = frontface(I_F)
...
%end
   ...
   % disp(my_folder);
    ...
    [BW_mask_F,mask_F,rt_boundary_col,lt_boundary_col,~,lower_boundary_row]=face_detect_new( I_F); % Perform Face-Detection
