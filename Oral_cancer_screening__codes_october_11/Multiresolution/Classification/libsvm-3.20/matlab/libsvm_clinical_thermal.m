...
function [final_accuracy,indices,optns,model]= libsvm_clinical_thermal(xdata,Target_train,no_of_folds)
group = Target_train;
...
xdata_train1 = data_train(:,[1:33]);
xdata_test1 = data_test(:,[1:33]);
%============================  Grid search for parameter selection %=============================
[xdata_train1,min_data_train,max_data_train]=minmax_featureNormalize(xdata_train1);
data_train=[xdata_train1(:,1:33),data_train(:,34:end)];
 bestcv = 0;
    for log2c = 1:10,
        for log2g = -10:10,
...
%============================  Classification Part %=============================
[xdata_test1]=minmax_featureNormalize_test(xdata_test1,min_data_train,max_data_train);
data_test=[xdata_test1(:,1:33),data_test(:,34:end)];
