...
elseif (strcmp(User_Choice,'5')==1)
    ...
    d1 = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase_old\Malignant');%%% d stores a structure of 6 fields
        ...
        d2 = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase_old\Normal');%%% d stores a structure of 6 fields
        ...
        d3 = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase_old\NonMalignant');%%% d stores a structure of 6 fields
    ...
    idx=1;
    sacle_idx=2:6;      % scale_idx is the variable which stores scale of the gabor filters. Here we considered 5 different scales.
    AROI_Gabor_HM_M_Frontal_old=cell(numel(sacle_idx),1);
    AROI_Gabor_HM_P_Frontal_old=cell(numel(sacle_idx),1);
    AROI_Gabor_HM_N_Frontal_old=cell(numel(sacle_idx),1);
    %---for each scale gabor features are calculated, appended and saved.---%
    for sacle_idx=2:6
...
%           AROI_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx);
        ...
        load(['..\..\..\GaborFeatures_HM_allScale\AROI_Gabor_HM_Malignant_Frontal_face_scale_old',num2str(sacle_idx),'.mat']);
        load(['..\..\..\GaborFeatures_HM_allScale\AROI_Gabor_HM_Normal_Frontal_face_scale_old',num2str(sacle_idx),'.mat']);
        load(['..\..\..\GaborFeatures_HM_allScale\AROI_Gabor_HM_Precancer_Frontal_face_scale_old',num2str(sacle_idx),'.mat']);
        AROI_Gabor_HM_M_Frontal_old{idx,1}=AROI_Malignant_Gabor_HM_append_LT_RT_Frontface;
        AROI_Gabor_HM_P_Frontal_old{idx,1}=AROI_Precancer_Gabor_HM_append_LT_RT_Frontface;
        AROI_Gabor_HM_N_Frontal_old{idx,1}=AROI_Normal_Gabor_HM_append_LT_RT_Frontface;
        idx=idx+1;
    ...
    save('AROI_Gabor_HM_M_Frontal_old','AROI_Gabor_HM_M_Frontal_old');
    save('AROI_Gabor_HM_P_Frontal_old','AROI_Gabor_HM_P_Frontal_old');
    save('AROI_Gabor_HM_N_Frontal_old','AROI_Gabor_HM_N_Frontal_old');
    %================================================%
    ...
    %cd('..\GaborFeatures_HM_allScale');
    cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\GaborFeatures_HM_allScale');
    size_M=size(AROI_Gabor_HM_M_Frontal_old{1,1},1);
    size_P=size(AROI_Gabor_HM_P_Frontal_old{1,1},1);
    size_N=size(AROI_Gabor_HM_N_Frontal_old{1,1},1);
    ro_NM=size_N/size_M;
    ro_NP=size_N/size_P;
    load('AROI_Gabor_HM_M_Frontal_old','AROI_Gabor_HM_M_Frontal_old');
     AROI_Gabor_HM_M_Frontal_old = improve_imbalance(AROI_Gabor_HM_M_Frontal_old,ro_NM);
    load('AROI_Gabor_HM_P_Frontal_old','AROI_Gabor_HM_P_Frontal_old');
      AROI_Gabor_HM_P_Frontal_old = improve_imbalance(AROI_Gabor_HM_P_Frontal_old,ro_NP);
    load('AROI_Gabor_HM_N_Frontal_old','AROI_Gabor_HM_N_Frontal_old');
    
    %cd('..\Classification\libsvm-3.20\matlab');
    cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\Classification\libsvm-3.20\matlab');
    
    %=================Malignant vs Normal==================%
    viz_case='AROI_Full_MN_Frontal_old'
    folder_name=['AROI_Full_Gabor_MN_Frontal_old'];
    save_mat='MN_Parameters_Frontal_old';
 ...
 [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Frontal_old,AROI_Gabor_HM_N_Frontal_old,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    cd('../../../');
    
    
    %=================Precancer vs Normal ==================%
    viz_case='AROI_Full_PN_Frontal_old'
    folder_name=['AROI_Full_Gabor_PN_Frontal_old' ];
    save_mat='PN_Parameters_Frontal_old';
    results_save_dir='GaborResults\AutomatedROI';
    ...
    %---------------------
       ...
       [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_P_Frontal_old,AROI_Gabor_HM_N_Frontal_old,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
...
%       AROI_AgeAdjust_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx);
    ...
    [final_accuracy_MN] = run_Gabor_libsvm_AgeAdjust(AROI_AgeAdjust_Gabor_HM_M_Frontal,AROI_AgeAdjust_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    ...
    [final_accuracy_PN] = run_Gabor_libsvm_AgeAdjust(AROI_AgeAdjust_Gabor_HM_P_Frontal,AROI_AgeAdjust_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
