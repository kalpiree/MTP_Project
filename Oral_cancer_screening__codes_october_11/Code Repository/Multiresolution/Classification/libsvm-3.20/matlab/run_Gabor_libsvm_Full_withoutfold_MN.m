...
[final_accuracy,indices,optns,save_optns,save_prob_estimates,model,save_idx_validate,save_True_Label_test,save_Predict_label_test,save_best_kernel_model,save_bst_kernel_idx,save_data_test,save_data_train,save_data_validate,avg_sen,avg_spc,counter]=libsvm_scaleselect_withoutfold_MN(xdata_allscale,Target_train,no_of_folds,scales,viz_case,Flag,Setting,nameFolds)
%=================Saving Results========================%
