...
%                 GT_Malignant_MR8_Diff_LT_RT_Frontface 
%                GT_Malignant_MR8_mean_LT_RT_Frontface 
%                GT_Malignant_MR8_append_LT_RT_Frontface
%                 GT_NMalignant_MR8_Diff_LT_RT_Frontface
%                 GT_NMalignant_MR8_mean_LT_RT_Frontface 
%                 GT_NMalignant_MR8_append_LT_RT_Frontface
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
%   Nil
...
save(['..\MR8Features\Full_GT_MR8_Normal_Frontal_face_ROS_',num2str(ROS_idx),'.mat'],'GT_Normal_MR8_Diff_LT_RT_Frontface','GT_Normal_MR8_mean_LT_RT_Frontface','GT_Normal_MR8_append_LT_RT_Frontface');
%%
 %Malignant
...
save(['..\MR8Features\Full_GT_MR8_Malignant_Frontal_face_ROS_',num2str(ROS_idx),'.mat'],'GT_Malignant_MR8_Diff_LT_RT_Frontface','GT_Malignant_MR8_mean_LT_RT_Frontface' ,'GT_Malignant_MR8_append_LT_RT_Frontface');
...
save(['..\MR8Features\Full_GT_MR8_NonMalignant_Front_face_ROS_',num2str(ROS_idx),'.mat'],'GT_NMalignant_MR8_Diff_LT_RT_Frontface','GT_NMalignant_MR8_mean_LT_RT_Frontface' ,'GT_NMalignant_MR8_append_LT_RT_Frontface');
