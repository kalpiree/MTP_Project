...
xdata_train = data_train(:,[1]);
xdata_test = data_test(:,[1]);
%============================  Grid search for parameter selection %=============================
[xdata_train,min_data_train,max_data_train]=minmax_featureNormalize(xdata_train);
data_train=[xdata_train(:,1),data_train(:,2:end)];
 bestcv = 0;
    for log2c = 1:10,
        for log2g = -10:10,
...
%============================  Classification Part %=============================
[xdata_test]=minmax_featureNormalize_test(xdata_test,min_data_train,max_data_train);
data_test=[xdata_test(:,1),data_test(:,2:end)];
