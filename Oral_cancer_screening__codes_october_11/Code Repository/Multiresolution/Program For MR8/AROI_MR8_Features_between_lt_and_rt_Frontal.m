% =========================== AROI_MR8_Features_between_lt_and_rt_Frontal.m ====================================== %
% Description  : 
% 
% ================================================================================== %
% Input Parameters :
...
%------------------------------------------------------------------------------------%  
% Output parameter: 
%                 AROI_Normal_MR8_Diff_LT_RT_Frontface 
%                 AROI_Normal_MR8_mean_LT_RT_Frontface 
%                 AROI_Normal_MR8_append_LT_RT_Frontface
%                  AROI_Malignant_MR8_Diff_LT_RT_Frontface
%                 AROI_Malignant_MR8_mean_LT_RT_Frontface
%                 AROI_Malignant_MR8_append_LT_RT_Frontface
%                  AROI_NMalignant_MR8_Diff_LT_RT_Frontface
%                  AROI_NMalignant_MR8_mean_LT_RT_Frontface 
%                 AROI_NMalignant_MR8_append_LT_RT_Frontface
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
%   Nil
...
% ===================================================================== %
%%%%%AROI_MR8_Features_between_lt_and_rt_Frontal
function AROI_MR8_Features_between_lt_and_rt_Frontal(ROS_idx)
%%
 %Normal
...
cd([rel_path 'AROI_MR8_Normal_Front_' nameFolds{folder_idx} ]);
load('Full_AROI_MR8_Normal_Front.mat')
...
save(['..\MR8Features\Full_AROI_MR8_Normal_Frontal_face_ROS_',num2str(ROS_idx),'.mat']','AROI_Normal_MR8_Diff_LT_RT_Frontface','AROI_Normal_MR8_mean_LT_RT_Frontface','AROI_Normal_MR8_append_LT_RT_Frontface');
%%
 %Malignant
...
cd([rel_path 'AROI_MR8_Malignant_Front_' nameFolds{folder_idx}]);
load('Full_AROI_MR8_Malignant_Front.mat')
...
save(['..\MR8Features\Full_AROI_MR8_Malignant_Frontal_face_ROS_',num2str(ROS_idx),'.mat']','AROI_Malignant_MR8_Diff_LT_RT_Frontface','AROI_Malignant_MR8_mean_LT_RT_Frontface' ,'AROI_Malignant_MR8_append_LT_RT_Frontface');
...
cd([rel_path 'AROI_MR8_precancer_Front_' nameFolds{folder_idx}]);
load('Full_AROI_MR8_Precancer_Front.mat')
...
save(['..\MR8Features\Full_AROI_MR8_NonMalignant_Front_face_ROS_',num2str(ROS_idx),'.mat']','AROI_NMalignant_MR8_Diff_LT_RT_Frontface','AROI_NMalignant_MR8_mean_LT_RT_Frontface' ,'AROI_NMalignant_MR8_append_LT_RT_Frontface');
