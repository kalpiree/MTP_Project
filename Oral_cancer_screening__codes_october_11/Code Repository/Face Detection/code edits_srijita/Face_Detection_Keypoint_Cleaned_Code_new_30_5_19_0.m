...
%%
function [A_ROI_R,A_ROI_L]=Face_Detection_Keypoint_Cleaned_Code_new(filename,pathname)
%dbstop if error
%close all
%clear all
%clc
...
%for folder_idx= no_dir
  ...
  %  imshow(data);
    ...
    [BW_mask_F,mask_F,rt_boundary_col,lt_boundary_col,upper_boundary_row,lower_boundary_row]=face_detect_new( filename,pathname); % Perform Face-Detection
