% ===========================GT_Malignant_Texture_Frontal_Face_thermal.m ====================================== %
...
%------------------------------------------------------------------------------------%  
% Output parameter:  
%  GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt (13x1 double)
%                  
%  GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt (13x1 double)
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
%   #1: GLCM_D_THETA.m
%   #2: haralick_ours.m
%
% Called by :  GT_Malignant_Texture_Frontal_Face_thermal.m
%------------------------------------------------------------------------------------%
% Reference:    
%
...
% ===================================================================== %
function GT_Malignant_Texture_Frontal_Face_thermal 
%%
clear;
clc;
close all;
...
d = dir('..\..\..\ThermalDatabase\Malignant'); %  'd' stores all the subfolders for a given directory
...
%-------------------Loading the left and right ROI ( Ground Truth) -------------------------------------------------------------------------------------------%
       folder_name=['..\..\..\ThermalDatabase\Malignant\', nameFolds{folder_idx}, '\Front_ROI_' nameFolds{folder_idx}];
                ...
                cd(folder_name);
                load('Face_Mask.mat');%%% loading the facial mask
...
ROI_img_face_rt=logical(mask_F_normal_rt);%%% 'ROI_img_face_rt' our region of interest at the right part of the face
ROI_img_face_lt=logical(mask_F_normal_lt);%%% 'ROI_img_face_lt' our region of interest at the left part of the face
GT_ROI_R=I1.*uint8(ROI_img_face_rt);%%%'GT_ROI_R' gray scale ROI
GT_ROI_L=I1.*uint8(ROI_img_face_lt);%%%'GT_ROI_L' gray scale ROI
...
[GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt]=haralick_ours(GT_ROI_R,sum_GC_d1_theta0_45_90_135_ROI_img_face_rt); % calculating haralik features on rotation invariant GLCM
...
[GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt]=haralick_ours(GT_ROI_L,sum_GC_d1_theta0_45_90_135_ROI_img_face_lt);

%%----------------------Saving the extracted feature (START)
...
save('GT_Malignant_Haralick_Frontal_Face_d1_theta0_45_90_135','GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_rt','GT_Malignant_haralick_d1_theta0_45_90_135_ROI_img_face_lt');
%%------------------Saving the extracted feature (STOP)
