%%%%%%--------------------PROFILE FACE ROI EXTRACTION: MALIGNANT SUBJECT--------------%%%%
...
load(['..\ThermalDatabase\Malignant\',nameFolds{folder_idx},'\GT_FacialMask\',nameFolds{folder_idx},'_LTmask.mat']); %load the mask created from interactive segmentation tool
...
load(['..\ThermalDatabase\Malignant\',nameFolds{folder_idx},'\GT_FacialMask\',nameFolds{folder_idx},'_RTmask.mat']); %load the mask created from interactive segmentation tool
img_face_rt=rt_face;
...
LRface_keypts = xlsread('Thermal_Malignant_keypts_LRface.xlsx'); %
