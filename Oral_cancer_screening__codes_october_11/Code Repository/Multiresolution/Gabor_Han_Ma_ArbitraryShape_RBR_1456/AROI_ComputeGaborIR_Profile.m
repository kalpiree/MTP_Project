...
%                    
%------------------------------------------------------------------------------------%  
% Output parameter: AROI_Gabor_H&M_Precancer_Profile 
%                   AROI_gabor_P_precancer_lt  
%                   AROI_gabor_P_precancer_rt
%                   AROI_Gabor_H&M_Normal_Profile 
%                   AROI_gabor_P_normal_lt 
%                   AROI_gabor_P_normal_rt
%                   AROI_Gabor_H&M_Malignant_Profile
%                   AROI_gabor_P_malignant_lt
%                   AROI_gabor_P_malignant_rt
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
...
function AROI_GT_ComputeGaborIR_Profile(sacle_idx)
%%
...
% 
       ...
       %-------------------------------------------------loading Ground Truth facial mask-------------------------------------------------------------------------------------------%
                ...
                folder_name=['..\..\..\ThermalDatabase\Normal\', nameFolds{folder_idx}, '\Automatic_Profile_ROI_' nameFolds{folder_idx}];
            ...
            cd(rel_path);
            folder_name=['AROI_Gabor_Han&Ma_Normal_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
...
%%MALIGNANT%%%%%%%%%%%%%%%%%%%%%%%%%
           ...
           %-------------------------------------------------loading Manual facial mask-------------------------------------------------------------------------------------------%
            ...
            folder_name=['..\..\..\ThermalDatabase\Malignant\', nameFolds{folder_idx}, '\Automatic_Profile_ROI_' nameFolds{folder_idx}];
            ...
            cd(rel_path);
            folder_name=['AROI_Gabor_Han&Ma_Malignant_Profile_' nameFolds{folder_idx}];
...
%             I1_rt=mat2gray(I1_rt);
            ...
            I1_rt=range_rt.*(I1_rt-minval_rt); %bringing the image to a scale of 0.0-1.0
             ...
             I1_rt = adapthisteq((I1_rt));
                   ...
                   %-------------------------------------------------loading facial mask-------------------------------------------------------------------------------------------%
% 
            folder_name=['..\..\..\ThermalDatabase\NonMalignant\', nameFolds{folder_idx}, '\Automatic_Profile_ROI_' nameFolds{folder_idx}];
            ...
            cd(rel_path);
            folder_name=['AROI_Gabor_Han&Ma_precancer_Profile_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
