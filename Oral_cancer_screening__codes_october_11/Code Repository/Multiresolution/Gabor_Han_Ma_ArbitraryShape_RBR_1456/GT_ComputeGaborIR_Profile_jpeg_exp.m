...
function GT_ComputeGaborIR_Profile_jpeg_exp(sacle_idx)
%%
...
%%NORMAL%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            I1_lt = rgb2gray((imread(['..\..\..\Thermal db\Normal\',nameFolds{folder_idx},'\jpeg\jpeg exp\',nameFolds{folder_idx},'_lt.jpg'])));
            I1_lt= im2double(I1_lt);
            I1_rt = rgb2gray((imread(['..\..\..\Thermal db\Normal\',nameFolds{folder_idx},'\jpeg\jpeg exp\',nameFolds{folder_idx},'_rt.jpg'])));
            I1_rt= im2double(I1_rt);
...
%%MALIGNANT%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            %I1_lt = xlsread(['..\..\..\ThermalDatabase\Malignant\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'_lt.csv']);
             I1_lt = rgb2gray((imread(['..\..\..\Thermal db\Malignant\',nameFolds{folder_idx},'\Jpeg exp\',nameFolds{folder_idx},'_lt.jpg'])));
             I1_lt = im2double(I1_lt);
            %I1_rt = xlsread(['..\..\..\ThermalDatabase\Malignant\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'_rt.csv']);
            I1_rt = rgb2gray((imread(['..\..\..\Thermal db\Malignant\',nameFolds{folder_idx},'\Jpeg exp\',nameFolds{folder_idx},'_rt.jpg'])));
            I1_rt = im2double(I1_rt);
...
%%%%%%%%%%NONMALIGNANT%%%%%%%%%%%%%%%%%%%
            ...
            I1_lt = rgb2gray((imread(['..\..\..\Thermal db\NonMalignant\',nameFolds{folder_idx},'\Jpeg exp\',nameFolds{folder_idx},'_lt.jpg'])));
            I1_lt = im2double(I1_lt);
            %I1_rt = xlsread(['..\..\..\ThermalDatabase\NonMalignant\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'_rt.csv']);
            I1_rt = rgb2gray((imread(['..\..\..\Thermal db\NonMalignant\',nameFolds{folder_idx},'\Jpeg exp\',nameFolds{folder_idx},'_rt.jpg'])));
            I1_rt = im2double(I1_rt);
