% =========================== GT_Histogram_Frontal_Face_Malignant.m ====================================== %
% Description  : Call this function to extract the features from ground truth ROI
%  of IR Frontal Facial image (Malignant subjects).
% 
%
%
% ================================================================================== %
...
function GT_Histogram_Frontal_Face_Malignant
%%
clear;
clc;
close all;
