...
function GT_ComputeGaborIR_Frontal_jpeg_exp(sacle_idx)
%%
...
%%
% 'Normal Subjects'
d = dir('..\..\..\Thermal db\Normal');%%% d stores a structure of 6 fields
...
%     ----------------------------------------------------Read Frontal img-------------------------------------------------------------------------------------------%
    ...
    I1 = rgb2gray((imread(['..\..\..\Thermal db\Normal\',nameFolds{folder_idx},'\','jpeg\Jpeg exp\',nameFolds{folder_idx},'.jpg'])));
    I1 = im2double(I1);
    
    
%     ===========bringing the image to a scale offloating point 0.0-1.0
    maxval=max(max(I1));
    minval=min(min(I1));
...
for folder_idx=1:12
    ...
    I1 = rgb2gray((imread(['..\..\..\Thermal db\Malignant\',nameFolds{folder_idx},'\Jpeg exp\',nameFolds{folder_idx},'.jpg'])));
    I1 = im2double(I1);
...
for folder_idx=1:12
    ...
    I1 = rgb2gray((imread(['..\..\..\Thermal db\NonMalignant\',nameFolds{folder_idx},'\Jpeg exp\',nameFolds{folder_idx},'.jpg'])));
    I1 = im2double(I1);
