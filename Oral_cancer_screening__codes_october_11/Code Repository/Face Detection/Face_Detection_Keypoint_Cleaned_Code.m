...
if (strcmp(User_Choice, 'N')==1)
    d = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Normal'); % Reading Dir of the Specified Folder
...
elseif (strcmp(User_Choice, 'M')==1)
    d = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Malignant'); % Reading Dir of the Specified Folder
elseif (strcmp(User_Choice, 'P')==1)
    d = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Non malignant'); % Reading Dir of the Specified Folder
else
    disp('Invalid Choice');
    return
end
...
%
%for folder_idx= no_dir-51:no_dir-51
for folder_idx= 71:no_dir
   ...
   fprintf('Processing Patient ID '); disp(nameFolds(folder_idx)); % Display Current Patient ID
    ...
    if (strcmp(User_Choice, 'N')==1)
        I_F=xlsread(['C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Normal\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'.csv']);
    ...
    elseif (strcmp(User_Choice, 'M')==1)
        ...
        folder_name=['A_ROI_Front_' nameFolds{folder_idx}];
    elseif (strcmp(User_Choice, 'P')==1)
        I_F=xlsread(['C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Non malignant\',nameFolds{folder_idx},'\',nameFolds{folder_idx},'.csv']);
    ...
    I_F_cpy=I_F;
    op_img1=nameFolds(folder_idx); % Storing Patient ID
    [BW_mask_F,mask_F,rt_boundary_col,lt_boundary_col,~,lower_boundary_row]=face_detect( I_F,nameFolds,folder_idx,op_img1 ); % Perform Face-Detection
    ...
    cd 'C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Face Detection';
