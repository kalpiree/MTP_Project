% ===========================GT_PN_pvalue_AUC_FrontalFace.m ====================================== %
...
function GT_PN_pvalue_AUC_FrontalFace
clear;

enter_pvalue=0.05;

load('..\HaralickFeatures\GT_Haralick_Normal_Frontal_face.mat');
load('..\HaralickFeatures\GT_Haralick_NMalignant_Frontal_face.mat');
...
[~,p_concatinate,~,~] = ttest2(dataTrainPrecancerous_concatinate,dataTrainNormal_concatinate,'Vartype','unequal');
...
%%
save('..\HaralickFeatures\SignifantFeatures\GT_Significant_Haralick_PrecancerousNormal_Frontal','GT_SignificantPrecancerous_Frontal_LTandRT_append','GT_SignificantNormal_Frontal_LTandRT_append');
