...
for folder_idx= 1:no_dir
    ...
    I= imread(['C:\Users\ntnbs\Downloads\Database\Normal\',nameFolds{folder_idx},'\','A_ROI_Front_',nameFolds{folder_idx},'\','A_ROI_frontalL_img.png']);
    for bw = 1:1:5
        for theta = 0:30:180
    ...
    I= imread(['C:\Users\ntnbs\Downloads\Database\Normal\',nameFolds{folder_idx},'\','A_ROI_Front_',nameFolds{folder_idx},'\','A_ROI_frontalR_img.png']);
    for bw = 1:1:5
        for theta = 0:30:180
            gb = gabor_self(I,bw,theta);
            Data1(1,q) = kurtosis(gb,1,'all');
    ...
    I= imread(['C:\Users\ntnbs\Downloads\Database\Normal\',nameFolds{folder_idx},'\','A_ROI_Profile_',nameFolds{folder_idx},'\','A_ROI_profileL_img.png']);
    for bw = 1:1:5
        for theta = 0:30:180
            gb = gabor_self(I,bw,theta);
            Data1(1,q) = kurtosis(gb,1,'all');
    ...
    I= imread(['C:\Users\ntnbs\Downloads\Database\Normal\',nameFolds{folder_idx},'\','A_ROI_Profile_',nameFolds{folder_idx},'\','A_ROI_profileR_img.png']);
    for bw = 1:1:5
        for theta = 0:30:180
            gb = gabor_self(I,bw,theta);
            Data1(1,q) = kurtosis(gb,1,'all');
