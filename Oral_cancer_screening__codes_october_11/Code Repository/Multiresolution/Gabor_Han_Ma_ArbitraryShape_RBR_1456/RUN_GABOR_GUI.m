...
%                       2.Improve_balance function added to improve
...
%           AROI_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx);
 ...
 [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Frontal,AROI_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    cd('../../../');
    ...
    %---------------------
       ...
       [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_P_Frontal,AROI_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
