...
if (strcmp(User_Choice, 'N')==1)
    d = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase_old\Normal'); % Reading Dir of the Specified Folder
...
elseif (strcmp(User_Choice, 'M')==1)
    d = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase_old\Malignant'); % Reading Dir of the Specified Folder
elseif (strcmp(User_Choice, 'P')==1)
    d = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase_old\NonMalignant'); % Reading Dir of the Specified Folder
else
    disp('Invalid Choice');
    return
end
...
%if ~exist(folder_name)
 ...
 %cd('..\..\');
            ...
            cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Profile Face Detection');
      end            
