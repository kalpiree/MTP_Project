% ===========================  AROI_AgeAdjust_ComputeGaborIR_Frontal.m ====================================== %
% Description  : 
% 
%
%
...
%                    
%------------------------------------------------------------------------------------%  
% Output parameter:  AROI_AgeAdjust_Gabor_H&M_Normal_Front 
%                    AROI_gabor_F_normal_lt 
%                    AROI_gabor_F_normal_rt  
%                    
%                    
%------------------------------------------------------------------------------------%
% Subroutine  called : 
...
function AROI_AgeAdjust_ComputeGaborIR_Frontal(sacle_idx)
%%
...
%'Normal Subjects' 
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
           ...
           %-------------------Loading the left and right ROI (Automated ROI) -------------------------------------------------------------------------------------------%
            ...
            rel_path=['..\..\..\ThermalDatabase\Normal_AgeAdjust\',nameFolds{folder_idx}];
            cd(rel_path);
            folder_name=['AROI_AgeAdjust_Gabor_Han&Ma_Normal_Front_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                ...
                save('AROI_AgeAdjust_Gabor_H&M_Normal_Front','AROI_gabor_F_normal_lt','AROI_gabor_F_normal_rt');
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            rel_path=['..\..\..\ThermalDatabase\Malignant\',nameFolds{folder_idx}];
            cd(rel_path);
            folder_name=['AROI_AgeAdjust_Gabor_Han&Ma_Malignant_Front_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('AROI_AgeAdjust_Gabor_H&M_Malignant_Front','AROI_gabor_F_malignant_lt','AROI_gabor_F_malignant_rt');
...
%% 'Precancerous Subjects'  
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%           
            ...
            rel_path=['..\..\..\ThermalDatabase\NonMalignant\',nameFolds{folder_idx}];
            cd(rel_path);
            folder_name=['AROI_AgeAdjust_Gabor_Han&Ma_precancer_Front_' nameFolds{folder_idx}];
            % rmdir(folder_name);
                if ~exist(folder_name)
                    mkdir(folder_name);
                    cd(folder_name);
               ...
               save('AROI_AgeAdjust_Gabor_H&M_Precancer_Front','AROI_gabor_F_precancer_lt','AROI_gabor_F_precancer_rt');
