...
%     GT_Gabor_HM_P_Frontal = improve_imbalance(GT_Gabor_HM_P_Frontal);
    ...
    Setting='GT_MN_FULL';
      ...
      [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(GT_Gabor_HM_M_Frontal,GT_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    ...
    %---------------------
      ...
      [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(GT_Gabor_HM_P_Frontal,GT_Gabor_HM_N_Frontal,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
...
%             AgeAdjust_GT_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx);
    ...
    Setting='GT_MN_AGE';
     ...
     [final_accuracy_MN,sensivity_MN,specificity_MN]= run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_M_F,AgeAdjust_GT_Gabor_HM_N_F,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting);
    ...
    [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_P_F,AgeAdjust_GT_Gabor_HM_N_F,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting);
...
%      GT_Gabor_HM_P_Profile = improve_imbalance(GT_Gabor_HM_P_Profile);
    ...
    sacle_idx=2:6;
    Flag='0'; %put Flag=0 if want to compute crossvalidation index all over again
    ...
    [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(GT_Gabor_HM_M_Profile,GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    cd('../../../');
    ...
    [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(GT_Gabor_HM_P_Profile,GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
...
%         AgeAdjust_GT_Gabor_HMFeatures_between_lt_and_rt_Profile(sacle_idx);
    ...
    [final_accuracy_MN,sensitivity_MN,specificity_MN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_M_Profile,AgeAdjust_GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
    cd('../../../');
    ...
    [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_AgeAdjust(AgeAdjust_GT_Gabor_HM_P_Profile,AgeAdjust_GT_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting)
...
elseif (strcmp(User_Choice,'5')==1)
    ...
    %d1 = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Malignant');%%% d stores a structure of 6 fields
    d1 = dir('C:\Users\ntnbs\Downloads\common_database\malignant');       
        ...
        %d2 = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Normal');%%% d stores a structure of 6 fields
        ...
        %d3 = dir('C:\Users\ntnbs\Downloads\trial\ThermalDatabase\ThermalDatabase\Non malignant');%%% d stores a structure of 6 fields
        d3 = dir('C:\Users\ntnbs\Downloads\common_database\non_malignant');
    ...
    idx=1;
    sacle_idx=2:6;      % scale_idx is the variable which stores scale of the gabor filters. Here we considered 5 different scales.
    AROI_Gabor_HM_M_Profile__=cell(numel(sacle_idx),1);
    AROI_Gabor_HM_P_Profile__=cell(numel(sacle_idx),1);
    AROI_Gabor_HM_N_Profile__=cell(numel(sacle_idx),1);
    %---for each scale gabor features are calculated, appended and saved.---%
    for sacle_idx=2:6
...
%           AROI_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx);
        ...
        %cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\Classification\libsvm-3.20\matlab');
        cd('C:\Users\ntnbs\Downloads\common_database\');
        %load(['..\..\..\GaborFeatures_HM_allScale\AROI_Gabor_HM_Malignant_Profile_face_scale_',num2str(sacle_idx),'.mat']);
        load(['C:\Users\ntnbs\Downloads\common_database\malignant',num2str(sacle_idx),'.mat']);
        %load(['..\..\..\GaborFeatures_HM_allScale\AROI_Gabor_HM_Normal_Profile_face_scale_',num2str(sacle_idx),'.mat']);
        load(['C:\Users\ntnbs\Downloads\common_database\normal',num2str(sacle_idx),'.mat']);
        %load(['..\..\..\GaborFeatures_HM_allScale\AROI_Gabor_HM_Precancer_Profile_face_scale_',num2str(sacle_idx),'.mat']);
        load(['C:\Users\ntnbs\Downloads\common_database\non_malignant',num2str(sacle_idx),'.mat']);
        AROI_Gabor_HM_M_Profile__{idx,1}=AROI_Malignant_Gabor_HM_append_LT_RT_Profileface;
        AROI_Gabor_HM_P_Profile__{idx,1}=AROI_Precancer_Gabor_HM_append_LT_RT_Profileface;
        AROI_Gabor_HM_N_Profile__{idx,1}=AROI_Normal_Gabor_HM_append_LT_RT_Profileface;
        idx=idx+1;
    ...
    %cd('..\GaborFeatures_HM_allScale');
    %cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\GaborFeatures_HM_allScale')
    cd('C:\Users\ntnbs\Downloads\common_database');
    save('AROI_Gabor_HM_M_Profile__','AROI_Gabor_HM_M_Profile__');
    save('AROI_Gabor_HM_P_Profile__','AROI_Gabor_HM_P_Profile__');
    save('AROI_Gabor_HM_N_Profile__','AROI_Gabor_HM_N_Profile__');
    %================================================%
    ...
    %cd('..\GaborFeatures_HM_allScale');
    cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\GaborFeatures_HM_allScale');
    size_M=size(AROI_Gabor_HM_M_Profile__{1,1},1);
    size_P=size(AROI_Gabor_HM_P_Profile__{1,1},1);
    size_N=size(AROI_Gabor_HM_N_Profile__{1,1},1);
    ro_NM=size_N/size_M;
    ro_NP=size_N/size_P;
    load('AROI_Gabor_HM_M_Profile__','AROI_Gabor_HM_M_Profile__');
     AROI_Gabor_HM_M_Profile__ = improve_imbalance(AROI_Gabor_HM_M_Profile__,ro_NM);
    load('AROI_Gabor_HM_P_Profile__','AROI_Gabor_HM_P_Profile__');
      AROI_Gabor_HM_P_Profile__ = improve_imbalance(AROI_Gabor_HM_P_Profile__,ro_NP);
    load('AROI_Gabor_HM_N_Profile__','AROI_Gabor_HM_N_Profile__');
    
    %cd('..\Classification\libsvm-3.20\matlab');
    cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\Classification\libsvm-3.20\matlab');
    
    %=================Malignant vs Normal==================%
    viz_case='AROI_Full_MN_Profile__'
    folder_name=['AROI_Full_Gabor_MN_Profile__'];
    save_mat='MN_Parameters_Profile__';
    results_save_dir='GaborResults\AutomatedROI';
    sacle_idx=2:6;
    Flag='0'; %put Flag=0 if want to compute crossvalidation index all over again
    
    Setting='AROI_MN__FULL';
    


 [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Profile__,AROI_Gabor_HM_N_Profile__,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    cd('../../../');
    
    
    %=================Precancer vs Normal ==================%
    viz_case='AROI_Full_PN_Profile__'
    folder_name=['AROI_Full_Gabor_PN_Profile__' ];
    save_mat='PN_Parameters_Profile__';
    results_save_dir='GaborResults\AutomatedROI';
    ...
    %---------------------
       ...
       [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_P_Profile__,AROI_Gabor_HM_N_Profile__,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
...
elseif (strcmp(User_Choice,'6')==1)
   ...
   %========================Start of Feature extraction%========================
    ...
    idx=1;
    sacle_idx=2:6;      % scale_idx is the variable which stores scale of the gabor filters. Here we considered 5 different scales.
    AROI_Gabor_HM_M_Frontal__=cell(numel(sacle_idx),1);
    AROI_Gabor_HM_P_Frontal__=cell(numel(sacle_idx),1);
    AROI_Gabor_HM_N_Frontal__=cell(numel(sacle_idx),1);
    %---for each scale gabor features are calculated, appended and saved.---%
    for sacle_idx=2:6
...
%           AROI_Gabor_HMFeatures_between_lt_and_rt_Frontal(sacle_idx);
        ...
        load(['C:\Users\ntnbs\Downloads\common_database\malignant_frontal',num2str(sacle_idx),'.mat']);
        load(['C:\Users\ntnbs\Downloads\common_database\normal_frontal',num2str(sacle_idx),'.mat']);
        load(['C:\Users\ntnbs\Downloads\common_database\non_malignant_frontal',num2str(sacle_idx),'.mat']);
        ...
        AROI_Gabor_HM_M_Frontal__{idx,1}=AROI_Malignant_Gabor_HM_append_LT_RT_Frontface;
        AROI_Gabor_HM_P_Frontal__{idx,1}=AROI_Precancer_Gabor_HM_append_LT_RT_Frontface;
        AROI_Gabor_HM_N_Frontal__{idx,1}=AROI_Normal_Gabor_HM_append_LT_RT_Frontface;
        idx=idx+1;
        %cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\Gabor_Han_Ma_ArbitraryShape_RBR_1456');
    end
    %========================End of Feature extraction%========================
    ...
    %cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\GaborFeatures_HM_allScale')
    cd('C:\Users\ntnbs\Downloads\common_database');
    save('AROI_Gabor_HM_M_Frontal__','AROI_Gabor_HM_M_Frontal__');
    save('AROI_Gabor_HM_P_Frontal__','AROI_Gabor_HM_P_Frontal__');
    save('AROI_Gabor_HM_N_Frontal__','AROI_Gabor_HM_N_Frontal__');
    %================================================%
    ...
    %cd('..\GaborFeatures_HM_allScale');
    cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\GaborFeatures_HM_allScale');
    size_M=size(AROI_Gabor_HM_M_Frontal__{1,1},1);
    size_P=size(AROI_Gabor_HM_P_Frontal__{1,1},1);
    size_N=size(AROI_Gabor_HM_N_Frontal__{1,1},1);
    ro_NM=size_N/size_M;
    ro_NP=size_N/size_P;
    load('AROI_Gabor_HM_M_Frontal__','AROI_Gabor_HM_M_Frontal__');
     AROI_Gabor_HM_M_Frontal__ = improve_imbalance(AROI_Gabor_HM_M_Frontal__,ro_NM);
    load('AROI_Gabor_HM_P_Frontal__','AROI_Gabor_HM_P_Frontal__');
      AROI_Gabor_HM_P_Frontal__ = improve_imbalance(AROI_Gabor_HM_P_Frontal__,ro_NP);
    load('AROI_Gabor_HM_N_Frontal__','AROI_Gabor_HM_N_Frontal__');
    
    %cd('..\Classification\libsvm-3.20\matlab');
    cd('C:\Users\ntnbs\Downloads\trial\Oral_cancer_screening_previous_codes\Code Repository\Multiresolution\Classification\libsvm-3.20\matlab');
    
    %=================Malignant vs Normal==================%
    viz_case='AROI_Full_MN_Frontal__'
    folder_name=['AROI_Full_Gabor_MN_Frontal__'];
    save_mat='MN_Parameters_Frontal__';
    results_save_dir='GaborResults\AutomatedROI';
    sacle_idx=2:6;
    Flag='0'; %put Flag=0 if want to compute crossvalidation index all over again
 ...
 [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Frontal__,AROI_Gabor_HM_N_Frontal__,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    cd('../../../');
    
    
    %=================Precancer vs Normal ==================%
    viz_case='AROI_Full_PN_Frontal__'
    folder_name=['AROI_Full_Gabor_PN_Frontal__' ];
    save_mat='PN_Parameters_Frontal__';
    results_save_dir='GaborResults\AutomatedROI';
    ...
    %---------------------
       ...
       [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_P_Frontal__,AROI_Gabor_HM_N_Frontal__,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
...
%           AROI_Gabor_HMFeatures_between_lt_and_rt_haralic_Profile(sacle_idx);
    ...
    [final_accuracy_MN,sensivity_MN,specificity_MN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Profile,AROI_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_MN)
    cd('../../../');
   ...
   [final_accuracy_PN,sensitivity_PN,specificity_PN] = run_Gabor_libsvm_Full(AROI_Gabor_HM_M_Profile,AROI_Gabor_HM_N_Profile,sacle_idx,viz_case,folder_name,save_mat,results_save_dir,Flag,Setting,nameFolds_PN)
