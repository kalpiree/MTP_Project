% =========================== GT_PN_kmeans_fuzzy.m ====================================== %
% Description  :
% 1. Classification for Non Malignant  vs normal, using cluster prototype
% classifier
%    
...
%
% ================================================================================== %
% Input Parameters : MAE128_Front_NonMalignant    --> Feature Patient
...
function [final_accuracy_fk,final_accuracy_k,no_of_cluster_fcm,no_of_cluster_kmeans,indices,center_fcm,center_kmeans,idx_kmeans,U_fcm]= GT_PN_kmeans_fuzzy(MAE128_Front_NonMalignant,MAE128_Front_Normal,Flag,Setting)
...
patient=MAE128_Front_NonMalignant;
...
if(Flag =='1')
    ...
    if(strcmp(Setting,'PN_F_FULL')==1)
        load('indices_PN_Front_Full.mat');
         indices=indices_PN;
    
    elseif(strcmp(Setting,'PN_F_AGE')==1)
        load('indices_PN_Front_AgeAdjust.mat');
         indices=indices_PN;
    
    elseif(strcmp(Setting,'PN_P_FULL')==1)
        load('indices_PN_Profile_Full.mat');
         indices=indices_PN;
    
    elseif(strcmp(Setting,'PN_P_AGE')==1)
         load('indices_PN_Profile_AgeAdjust.mat');
         indices=indices_PN;
